...
public class FirebaseRestaurantListAdapter extends FirebaseRecyclerAdapter<Restaurant, FirebaseRestaurantViewHolder> implements ItemTouchHelperAdapter {
    ...
    public FirebaseRestaurantListAdapter(Class<Restaurant> modelClass, int modelLayout,
        ...
        mRef = ref.getRef(); //this re-initized the reference
        ...
        mChildEventListener = mRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                Log.d("Zaske test", "onChildAdded: " + dataSnapshot.getValue(Restaurant.class).getName() );
    ...
    public boolean onItemMove(int fromPosition, int toPosition) {
        ...
        notifyItemMoved(fromPosition, toPosition); //Firebase built in method ??
        return false;
    }

    @Override
    public void onItemDismiss(int position) {
        //This deletes the item from Firebase
    ...
    protected void populateViewHolder(final FirebaseRestaurantViewHolder viewHolder, Restaurant model, int position) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("position", viewHolder.getAdapterPosition());  //getAdapterPosition gets the actual position, not its origin
